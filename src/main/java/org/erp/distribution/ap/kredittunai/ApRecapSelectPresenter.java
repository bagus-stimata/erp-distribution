...
public class ApRecapSelectPresenter implements ClickListener, ValueChangeListener{
	private ApRecapSelectModel model;
	private ApRecapSelectView view;
	
	public ApRecapSelectPresenter(ApRecapSelectModel model, ApRecapSelectView view){
		this.model = model;
		this.view = view;
