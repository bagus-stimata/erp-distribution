...
public class LapServiceRekapView extends CustomComponent{
	...
	public LapServiceRekapView(LapServiceRekapModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		comboGroup2.setNullSelectionAllowed(false);
	...
	public LapServiceRekapModel getModel() {
		return model;
	}
	...
	public void setModel(LapServiceRekapModel model) {
		this.model = model;
	}
