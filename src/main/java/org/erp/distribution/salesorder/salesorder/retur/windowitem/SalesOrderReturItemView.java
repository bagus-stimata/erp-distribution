...
public class SalesOrderReturItemView extends CustomComponent {
	...
	public SalesOrderReturItemView(SalesOrderReturItemModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.setComponentAlignment(btnClose, Alignment.BOTTOM_CENTER);
	...
	public SalesOrderReturItemModel getModel() {
		return model;
	}
	...
	public void setModel(SalesOrderReturItemModel model) {
		this.model = model;
	}
