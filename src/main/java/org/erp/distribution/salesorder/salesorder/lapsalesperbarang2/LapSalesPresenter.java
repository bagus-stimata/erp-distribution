...
public class LapSalesPresenter implements ClickListener{
	private LapSalesModel model;
	private LapSalesView view;

	public LapSalesPresenter(LapSalesModel model, LapSalesView view){
		this.model = model;
		this.view = view;
		initListener();
	}
	...
	public void preview(){
		...
		showPreview("/erp/distribution/reports/salesorder/lapsales/lapsalespersalesmanperbarang1.jasper", "salespersalesmanperbarang1");
