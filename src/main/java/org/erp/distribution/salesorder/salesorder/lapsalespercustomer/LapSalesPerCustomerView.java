...
public class LapSalesPerCustomerView extends CustomComponent{
	...
	private DateField dateField1From = new DateField("TANGGAL INVOICE MULAI");
	...
	public LapSalesPerCustomerView(LapSalesPerCustomerModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(comboGroup2);
	...
	public LapSalesPerCustomerModel getModel() {
		return model;
	}
	...
	public void setModel(LapSalesPerCustomerModel model) {
		this.model = model;
	}
