...
public class LapPackingListView extends CustomComponent{
	...
	private DateField dateField1From = new DateField("TANGGAL PENGIRIMAN");
	...
	public LapPackingListView(LapPackingListModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(dateField1To);
	...
	public LapPackingListModel getModel() {
		return model;
	}
	...
	public void setModel(LapPackingListModel model) {
		this.model = model;
	}
