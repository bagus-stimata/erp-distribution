...
import org.erp.distribution.salesorder.salesorder.retur.windowitem.SalesOrderReturItemPresenter;
import org.erp.distribution.salesorder.salesorder.retur.windowitem.SalesOrderReturItemView;
...
public class SalesOrderReturView extends CustomComponent{
	...
	private TextField fieldInvoiceno= new TextField("NO. INV RET");
	...
	public SalesOrderReturView(SalesOrderReturModel model){
		this.model = model;
		helper = new SalesOrderReturHelper(model, this);
...
//		        }
		...
		comboTipeJual.setItemCaption("C", "C");
		comboTipeJual.addItem("TF");
...
//		tabSheet.addStyleName("framed compact-tabbar small");
	...
	public void setTablePropertiesList(){
		...
		setVisibleTablePropertiesList("orderno", "fsalesmanBean.spcode", "fsalesmanBean.spname", "fcustomerBean.custno", "fcustomerBean.custname", "fwarehouseBean.id", 
				"fwarehouseBean.description","invoiceno", "orderdate", "invoicedate", 
...
//			tableDetil.setColumnCollapsed("subtotalafterdiscafterppn", true);
	...
	private SalesOrderReturItemModel itemDetilModel;
	private SalesOrderReturItemView itemDetilView;
	private SalesOrderReturItemPresenter itemDetilPresenter;
	...
	public SalesOrderReturHelper getHelper() {
		return helper;
	}
	...
	public SalesOrderReturItemModel getItemDetilModel() {
		return itemDetilModel;
	}

	public SalesOrderReturItemView getItemDetilView() {
		return itemDetilView;
	}

	public SalesOrderReturItemPresenter getItemDetilPresenter() {
	...
	public void setModel(SalesOrderReturModel model) {
		this.model = model;
	}

	public void setHelper(SalesOrderReturHelper helper) {
		this.helper = helper;
	}
	...
	public void setItemDetilModel(SalesOrderReturItemModel itemDetilModel) {
		this.itemDetilModel = itemDetilModel;
	}

	public void setItemDetilView(SalesOrderReturItemView itemDetilView) {
		this.itemDetilView = itemDetilView;
	}

	public void setItemDetilPresenter(
			SalesOrderReturItemPresenter itemDetilPresenter) {
