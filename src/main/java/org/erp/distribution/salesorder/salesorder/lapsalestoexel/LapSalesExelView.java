...
public class LapSalesExelView extends CustomComponent{
	...
	private Button btnPreview = new Button("Export To Exel");
	...
	public LapSalesExelView(LapSalesExelModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(comboGroup2);
	...
	public LapSalesExelModel getModel() {
		return model;
	}
	...
	public void setModel(LapSalesExelModel model) {
		this.model = model;
	}
