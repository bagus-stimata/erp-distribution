...
public class LapMutasiStockView extends CustomComponent{
	...
	public LapMutasiStockView(LapMutasiStockModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		panelTop.setContent(layoutTop);
	...
	public LapMutasiStockModel getModel() {
		return model;
	}
	...
	public void setModel(LapMutasiStockModel model) {
		this.model = model;
	}
