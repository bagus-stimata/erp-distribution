...
public class LapStockOpnameView extends CustomComponent{
	...
	public LapStockOpnameView(LapStockOpnameModel model){
		this.model = model;
		initComponent();
		buildView();
	...
	public LapStockOpnameModel getModel() {
		return model;
	}
	...
	public void setModel(LapStockOpnameModel model) {
		this.model = model;
	}
