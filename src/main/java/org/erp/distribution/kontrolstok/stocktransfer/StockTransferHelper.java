...
public class StockTransferHelper {
	...
	public StockTransferHelper(StockTransferModel model, StockTransferView view){
		this.model = model;
		this.view = view;
	}
...
//		model.itemHeader.setAmountafterdiscafterppn((double) Math.round(sumTotalAfterdiscAfterppn));
	...
	public List<FtStocktransferd> updateAndCalculateItemDetilFromList(List<FtStocktransferd> list) {
		...
		Iterator<FtStocktransferd> iter = list.iterator();
...
//		}
	...
	public boolean isValidSaveFormAdding(){
		...
		if (model.getItemHeader().getFwarehouseBeanFrom()==null) {
			isValid = false;
			message += "\n::GUDANG ASAL masih kosong!";			
		}
		if (model.getItemHeader().getFwarehouseBeanTo()==null) {
			isValid = false;
			message += "\n::GUDANG TUJUAN masih kosong!";			
		}
		if (model.getItemHeader().getFwarehouseBeanTo().equals(model.getItemHeader().getFwarehouseBeanFrom())) {
			isValid = false;
