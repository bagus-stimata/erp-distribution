...
public class LapSaldoStockView extends CustomComponent{
	...
	public LapSaldoStockView(LapSaldoStockModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(checkBox2);
	...
	public LapSaldoStockModel getModel() {
		return model;
	}
	...
	public void setModel(LapSaldoStockModel model) {
		this.model = model;
	}
