...
public class LapLabaRugiKotorView extends CustomComponent{
	...
	public LapLabaRugiKotorView(LapLabaRugiKotorModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		comboGroup2.setNullSelectionAllowed(false);
	...
	public LapLabaRugiKotorModel getModel() {
		return model;
	}
	...
	public void setModel(LapLabaRugiKotorModel model) {
		this.model = model;
	}
