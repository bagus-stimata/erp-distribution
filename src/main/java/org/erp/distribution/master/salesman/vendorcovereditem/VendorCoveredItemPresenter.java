...
public class VendorCoveredItemPresenter implements ClickListener, BlurListener, ValueChangeListener, Handler{
	private VendorCoveredItemModel model;
	private VendorCoveredItemView view;
	private VendorCoveredItemHelper helper;
	
	public VendorCoveredItemPresenter(VendorCoveredItemModel model, VendorCoveredItemView view){
		this.model = model;
		this.view = view;
		
		helper = new VendorCoveredItemHelper(model, view);
	...
	public void initListener(){
		...
		view.getComboVendor().addValueChangeListener(comboVendorChangeListener);
	...
	public void blur(BlurEvent event) {
		...
		if (event.getComponent()==view.getComboVendor()) {				
			helper.updateAndCalulateItemDetilProduct();
			helper.updateAndCalculateItemDetil();
	...
	public void editItemdetil(){		
		view.bindAndBuildFieldGroupComponent();				
		view.getComboVendor().setReadOnly(true);
...
//		model.itemDetil.setFproductBean((FProduct) view.getComboProduct().getValue());
	...
	public Action[] getActions(Object target, Object sender) {
		if (sender == view.getPanelComboVendor()) {
