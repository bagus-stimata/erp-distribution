...
public class VendorCoveredItemView extends CustomComponent {
	...
	private ComboBox comboVendor= new ComboBox("SUPPLIER");//		model.getBinderItemDetail().bind(fieldNomorUrut, "nourut");
	...
	public VendorCoveredItemView(VendorCoveredItemModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(fieldNomorUrut);
		panelComboVendor.setContent(comboVendor);
		layoutTop.addComponent(panelComboVendor);
...
//		layoutTop.setComponentAlignment(btnClose, Alignment.BOTTOM_CENTER);
	...
	public void bindAndBuildFieldGroupComponent(){
		...
		comboVendor.setNewItemsAllowed(false);
...
//		model.getBinderItemDetail().bind(comboProduct, "fproductBean");
		model.getBinderItemDetail().bind(fieldKode, "vcode");
		model.getBinderItemDetail().bind(fieldNama, "vname");
	...
	public void setModel(VendorCoveredItemModel model) {
		this.model = model;
	}
	...
	public void setPanelComboVendor(Panel panelComboVendor) {
		this.panelComboVendor = panelComboVendor;
	}
