...
public class VendorView extends CustomComponent{
	...
	private TextField fieldDescription= new TextField("PRINCIPAL/SUPPLIER");
	...
	private TextField fieldSearchByDesc = new TextField("SUPPLIER");
	...
	public VendorView(VendorModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//	tabSheet.addStyleName(Reindeer.TABSHEET_SMALL);
	...
	public void setDisplayTableFooter(){
		...
		table.setColumnFooter("vcode", "*Record: " + items.size());
...
//		comboGrup.setNullSelectionAllowed(false);
		...
		model.getBinderHeader().bind(fieldId, "vcode");
		model.getBinderHeader().bind(fieldDescription, "vname");
...
//		model.getBinderHeader().bind(checkStatusActive, "statusActive");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("vcode", "vname", "address1", "city1");
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		//set header
		table.setColumnHeader("vcode", "ID");
		table.setColumnHeader("vname", "PRINCIPAL/SUPLIER");
		table.setColumnHeader("address1", "ALAMAT");
		table.setColumnHeader("city1", "KOTA");
		
		
//		table.setColumnExpandRatio("vcode", 2);
//		table.setColumnExpandRatio("vname", 5);
