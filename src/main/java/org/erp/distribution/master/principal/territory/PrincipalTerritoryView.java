...
public class PrincipalTerritoryView extends CustomComponent{
	private PrincipalTerritoryModel model;

	private VerticalLayout content = new VerticalLayout();
	
	private Table table;
	
	private TextField fieldId = new TextField("ID TERRITORY");
	private ComboBox comboGrup = new ComboBox("P. AREA");
	private TextField fieldDescription= new TextField("TERRITORY/DISTRIBUTOR");
	...
	private ComboBox comboSearchByGrup = new ComboBox("P. AREA");
	private TextField fieldSearchById = new TextField("ID TERRITORY/DIST");
	private TextField fieldSearchByDesc = new TextField("TERRITORY/DISTRIBUTOR");
	...
	public PrincipalTerritoryView(PrincipalTerritoryModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		
		//Init isian combobox
		comboGrup.setContainerDataSource(model.getBeanItemContainerPArea());
		...
		model.getBinderHeader().bind(fieldDescription, "pdistributor");
		model.getBinderHeader().bind(comboGrup, "pareaBean");
...
//		model.getBinderHeader().bind(checkStatusActive, "statusActive");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "pareaBean",  "pdistributor");
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		//set header
		table.setColumnHeader("id", "ID TERRITORY/DIST");
		table.setColumnHeader("pareaBean", "AREA");
		table.setColumnHeader("pdistributor", "TERRITORY/DIST");
...
//		windowForm.setStyleName("login-layout");
	...
	public PrincipalTerritoryModel getModel() {
		return model;
	}
	...
	public void setModel(PrincipalTerritoryModel model) {
		this.model = model;
	}
