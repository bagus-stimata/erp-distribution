...
public class PrincipalRegionView extends CustomComponent{
	private PrincipalRegionModel model;

	private VerticalLayout content = new VerticalLayout();
	
	private Table table;
	
	private TextField fieldId = new TextField("ID REG");
	private ComboBox comboGrup = new ComboBox("GROUP");
	private TextField fieldDescription= new TextField("REGION");
	private TextField fieldNationalId= new TextField("NATIONAL ID");
	...
	private TextField fieldSearchById = new TextField("ID REG");
	private TextField fieldSearchByDesc = new TextField("REGION");
	...
	public PrincipalRegionView(PrincipalRegionModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
	...
	public void initComponent(){
		...
		fieldNationalId.setNullRepresentation("");
		...
		fieldNationalId.setWidth("200px");
...
//		btnRemoveItem.setIcon(new ThemeResource("../images/navigation/12x12/Erase.png"));
		...
		fieldNationalId.setRequired(true);
...
//		formLayout.addComponent(comboGrup);
		...
		formLayout.addComponent(fieldNationalId);
...
//		comboGrup.setNullSelectionAllowed(false);
		...
		model.getBinderHeader().bind(fieldDescription, "pregion");
		model.getBinderHeader().bind(fieldNationalId, "nationalId");
...
//		model.getBinderHeader().bind(checkStatusActive, "statusActive");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "pregion", "nationalId");
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		//set header
		table.setColumnHeader("id", "ID REG");
		table.setColumnHeader("pregion", "REGION");
		table.setColumnHeader("nationalId", "NATIONAL ID");
		
		
		table.setColumnExpandRatio("id", 2);
		table.setColumnExpandRatio("pregion", 5);
...
//		windowForm.setStyleName("login-layout");
	...
	public PrincipalRegionModel getModel() {
		return model;
	}
	...
	public void setModel(PrincipalRegionModel model) {
		this.model = model;
	}
