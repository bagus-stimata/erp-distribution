...
public class PrincipalAreaView extends CustomComponent{
	private PrincipalAreaModel model;

	private VerticalLayout content = new VerticalLayout();
	
	private Table table;
	
	private TextField fieldId = new TextField("ID AREA");
	private ComboBox comboGrup = new ComboBox("REGION");
	private TextField fieldDescription= new TextField("P. AREA");
	...
	private ComboBox comboSearchByGrup = new ComboBox("REGION");
	private TextField fieldSearchById = new TextField("ID AREA");
	private TextField fieldSearchByDesc = new TextField("P. AREA");
	...
	public PrincipalAreaView(PrincipalAreaModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		
		//Init isian combobox
		comboGrup.setContainerDataSource(model.getBeanItemContainerPRegion());
		...
		model.getBinderHeader().bind(fieldDescription, "parea");
		model.getBinderHeader().bind(comboGrup, "pregionBean");
...
//		model.getBinderHeader().bind(checkStatusActive, "statusActive");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "pregionBean",  "parea");
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		//set header
		table.setColumnHeader("id", "ID AREA");
		table.setColumnHeader("pregionBean", "REGION");
		table.setColumnHeader("parea", "P Area");
...
//		windowForm.setStyleName("login-layout");
	...
	public PrincipalAreaModel getModel() {
		return model;
	}
	...
	public void setModel(PrincipalAreaModel model) {
		this.model = model;
	}
