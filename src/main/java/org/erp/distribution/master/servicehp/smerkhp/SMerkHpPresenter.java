...
public class SMerkHpPresenter implements ClickListener, ValueChangeListener, ItemClickListener{
	private SMerkHpModel model;
	private SMerkHpView view;
	
	public SMerkHpPresenter(SMerkHpModel model, SMerkHpView view){
		this.model = model;
		this.view = view;
...
//		fd.extend(view.getBtnPrint());
	...
	public SMerkHpView getView() {
		return view;
	}
	public void setView(SMerkHpView view) {
		this.view = view;
	}
