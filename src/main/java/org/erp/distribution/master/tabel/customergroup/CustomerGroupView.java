...
public class CustomerGroupView extends CustomComponent{
	...
	private TextField fieldDescription= new TextField("CUST GROUP");
	...
	private ComboBox comboSearchByGrup = new ComboBox("CUST GROUP");
	private TextField fieldSearchById = new TextField("ID");
	private TextField fieldSearchByDesc = new TextField("CUST GROUP");
	...
	public CustomerGroupView(CustomerGroupModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		table.setColumnHeader("description", "GRUP JENIS");
