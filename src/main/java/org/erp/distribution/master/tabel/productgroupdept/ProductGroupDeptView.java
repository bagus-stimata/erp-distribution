...
public class ProductGroupDeptView extends CustomComponent{
	...
	private TextField fieldDescription= new TextField("PRODUCT DEPT");
	...
	private TextField fieldSearchByDesc = new TextField("PRODUCT DEPT");
	...
	public ProductGroupDeptView(ProductGroupDeptModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		table.setColumnHeader("description", "DEPARTEMEN");
