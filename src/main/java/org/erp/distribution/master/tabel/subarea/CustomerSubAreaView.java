...
public class CustomerSubAreaView extends CustomComponent{
	private CustomerSubAreaModel model;
	...
	private ComboBox comboGrup = new ComboBox("AREA");
	private TextField fieldDescription= new TextField("SUB AREA");
	...
	private ComboBox comboSearchByGrup = new ComboBox("AREA");
	private TextField fieldSearchById = new TextField("ID");
	private TextField fieldSearchByDesc = new TextField("SUB AREA");
	...
	public CustomerSubAreaView(CustomerSubAreaModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		
		//Init isian combobox
		comboGrup.setContainerDataSource(model.getBeanItemContainerArea());
		...
		model.getBinderHeader().bind(comboGrup, "fareaBean");
...
//		model.getBinderHeader().bind(checkStatusActive, "statusActive");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "fareaBean",  "description");
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		table.setColumnHeader("fareaBean", "AREA");
		table.setColumnHeader("description", "SUB AREA");
...
//		windowForm.setStyleName("login-layout");
	...
	public CustomerSubAreaModel getModel() {
		return model;
	}
	...
	public void setModel(CustomerSubAreaModel model) {
		this.model = model;
	}
