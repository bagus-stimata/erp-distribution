...
public class CustomerAreaView extends CustomComponent{
	...
	private TextField fieldDescription= new TextField("AREA");
	...
	private TextField fieldSearchByDesc = new TextField("AREA");
	...
	public CustomerAreaView(CustomerAreaModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		table.setColumnHeader("description", "AREA");
