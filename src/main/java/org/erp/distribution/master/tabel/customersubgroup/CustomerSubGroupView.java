...
public class CustomerSubGroupView extends CustomComponent{
	...
	private TextField fieldDescription= new TextField("JENIS CUSTOMER");
	...
	public CustomerSubGroupView(CustomerSubGroupModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		comboHargaAlternatif.setItemCaptionMode(ItemCaptionMode.EXPLICIT_DEFAULTS_ID);
		...
		model.getBinderHeader().bind(comboGrup, "fcustomergroupBean");
...
//		model.getBinderHeader().bind(checkStatusActive, "statusActive");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "fcustomergroupBean",  "description", "ftPriceAlthBean");
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		table.setColumnHeader("fcustomergroupBean", "GRUP JENIS");
		table.setColumnHeader("description", "JENIS");
		table.setColumnHeader("ftPriceAlthBean", "HRG ALTERNATIF");
