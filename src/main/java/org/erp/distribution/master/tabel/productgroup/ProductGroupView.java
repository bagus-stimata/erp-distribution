...
public class ProductGroupView extends CustomComponent{
	...
	private ComboBox comboGrup = new ComboBox("DEPT");
	private ComboBox comboGrup2 = new ComboBox("BRAND");
	private TextField fieldDescription= new TextField("PRODUCT GROUP");
	...
	private ComboBox comboSearchByGrup = new ComboBox("DEPT");
	private ComboBox comboSearchByGrup2 = new ComboBox("BRAND");
	private TextField fieldSearchById = new TextField("ID");
	private TextField fieldSearchByDesc = new TextField("PRODUCT GROUP");
	...
	public ProductGroupView(ProductGroupModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		
		//Init isian combobox
		comboGrup.setContainerDataSource(model.getBeanItemContainerGroupDept());
		comboGrup.setItemCaptionMode(ItemCaptionMode.EXPLICIT_DEFAULTS_ID);
		comboGrup.setFilteringMode(FilteringMode.CONTAINS);
		comboGrup.setNullSelectionAllowed(false);

		comboGrup2.setContainerDataSource(model.getBeanItemContainerGroupDivisi());
		...
		model.getBinderHeader().bind(comboGrup, "fproductgroupdeptBean");
		model.getBinderHeader().bind(comboGrup2, "fproductgroupdivisiBean");
...
//		model.getBinderHeader().bind(checkStatusActive, "statusActive");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id",  "description", "fproductgroupdeptBean", "fproductgroupdivisiBean");
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		table.setColumnHeader("description", "PRODUCT GROUP");
		table.setColumnHeader("fproductgroupdeptBean", "DEPT");
		table.setColumnHeader("fproductgroupdivisiBean", "BRAND");
...
//		windowForm.setStyleName("login-layout");
		windowForm.setWidth("600px");
		windowForm.setHeight("300px");
		windowForm.setClosable(false);	
	...
	public ProductGroupModel getModel() {
		return model;
	}
	...
	public void setModel(ProductGroupModel model) {
		this.model = model;
	}
