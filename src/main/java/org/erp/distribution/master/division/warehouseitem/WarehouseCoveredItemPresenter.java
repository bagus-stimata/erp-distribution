...
public class WarehouseCoveredItemPresenter implements ClickListener, BlurListener, ValueChangeListener, Handler{
	private WarehouseCoveredItemModel model;
	private WarehouseCoveredItemView view;
	private WarehouseCoveredItemHelper helper;
	
	public WarehouseCoveredItemPresenter(WarehouseCoveredItemModel model, WarehouseCoveredItemView view){
		this.model = model;
		this.view = view;
		
		helper = new WarehouseCoveredItemHelper(model, view);
	...
	public void initListener(){
		...
		view.getComboWarehouse().addBlurListener(this);
		...
		view.getComboWarehouse().addValueChangeListener(comboVendorChangeListener);
	...
	public void blur(BlurEvent event) {
		...
		if (event.getComponent()==view.getComboWarehouse()) {				
			helper.updateAndCalulateItemDetilProduct();
			helper.updateAndCalculateItemDetil();
	...
	public void editItemdetil(){		
		view.bindAndBuildFieldGroupComponent();				
		view.getComboWarehouse().setReadOnly(true);
