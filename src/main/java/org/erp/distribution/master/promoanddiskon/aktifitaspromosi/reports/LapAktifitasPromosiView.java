...
public class LapAktifitasPromosiView extends CustomComponent{
	private LapAktifitasPromosiModel model;

	private VerticalLayout content = new VerticalLayout();
	private ComboBox comboGroup1= new ComboBox("KODE AKTIFITAS PROMOSI");
	...
	public LapAktifitasPromosiView(LapAktifitasPromosiModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(checkBox2);
	...
	public void setDisplay(){
		...
		comboGroup1.setContainerDataSource(model.getBeanItemContainerFPromo());
...
//		comboGroup2.setContainerDataSource(model.getBeanItemContainerProductgroup());
	...
	public LapAktifitasPromosiModel getModel() {
		return model;
	}
	...
	public void setModel(LapAktifitasPromosiModel model) {
		this.model = model;
	}
