...
public class LapPriceListView extends CustomComponent{
	...
	public LapPriceListView(LapPriceListModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(dateField1To);
	...
	public LapPriceListModel getModel() {
		return model;
	}
	...
	public void setModel(LapPriceListModel model) {
		this.model = model;
	}
