...
import org.erp.distribution.master.producthargaalternatif.windowitem.HargaAlternatifItemModel;
import org.erp.distribution.master.producthargaalternatif.windowitem.HargaAlternatifItemPresenter;
import org.erp.distribution.master.producthargaalternatif.windowitem.HargaAlternatifItemView;
...
public class HargaAlternatifView extends CustomComponent{
	...
	private DateField dateFieldTrdate = new DateField("TGL TRANSAKSI");
	...
	public HargaAlternatifView(HargaAlternatifModel model){
		this.model = model;
		helper = new HargaAlternatifHelper(model, this);
...
//		        }
		...
		fieldDescription.setWidth("200px");
...
//		layoutTopList1.addComponent(fieldSearch2);
		...
		layoutTopDetil1.addComponent(fieldDescription);
...
//		fieldDiscrpafterppn.setVisible(false);
		...
		checkPosting.setVisible(false);
		btnPosting.setVisible(false);
		btnPostingBatal.setVisible(false);
...
//		model.getBinderHeader().bind(comboWarehouse, "fwarehouseBean");
	...
	public void fillComponentDetilItem(){
		...
		List<FtPriceAltd> list = new ArrayList<FtPriceAltd>();
		list = model.getFtPriceAltdJpaService().findAllDetilByRefno(model.getItemHeader().getRefno());
		
		//3. PERBAIKI CONTENT TRANSIENT
		List<FtPriceAltd> newList = new ArrayList<FtPriceAltd>();
	...
	public void setTablePropertiesList(){
		...
		setVisibleTablePropertiesList("refno", "norek", "description", "trdate", "posting");
		...
		tableList.setColumnHeader("trdate", "TGL TRANSAKSI");
...
//		tableList.setColumnExpandRatio("amountpay", 4);
	...
	public void setTablePropertiesDetil(){
		...
		"spricealt", "spricealtafterppn", "spricealt2", "spricealt2afterppn");
		...
		try{
			...
			tableDetil.setColumnCollapsed("spricealt", true);
			tableDetil.setColumnCollapsed("spricealt2", true);
			...
			tableDetil.setColumnCollapsed("spriceafterppn", true);
			tableDetil.setColumnCollapsed("sprice2before", true);
			tableDetil.setColumnCollapsed("sprice2afterppn", true);
		...
		//ALIGNMENT
		tableDetil.setColumnAlignment("id", Align.CENTER);
		...
		tableDetil.setColumnAlignment("fproductBean.pcode", Align.LEFT);
		...
		tableDetil.setColumnAlignment("spricealt", Align.RIGHT);
		tableDetil.setColumnAlignment("spricealtafterppn", Align.RIGHT);		
		tableDetil.setColumnAlignment("spricealt2", Align.RIGHT);
		tableDetil.setColumnAlignment("spricealt2afterppn", Align.RIGHT);
		...
		tableDetil.setColumnHeader("spricealt", "H.JUAL ALT");
		tableDetil.setColumnHeader("spricealtafterppn", "H.JUAL ALT+PPN");
		tableDetil.setColumnHeader("spricealt2", "H.JUALPCS");
		tableDetil.setColumnHeader("spricealt2afterppn", "H.JUALPCS ALT+PPN");
		...
		tableDetil.setColumnExpandRatio("spricealt", 5);
		tableDetil.setColumnExpandRatio("spricealtafterppn", 5);
		tableDetil.setColumnExpandRatio("spricealt2", 5);
		tableDetil.setColumnExpandRatio("spricealt2afterppn", 5);
	...
	private HargaAlternatifItemModel itemDetilModel;
	private HargaAlternatifItemView itemDetilView;
	private HargaAlternatifItemPresenter itemDetilPresenter;
	private Window windowForm = new Window();
	
	public void showWindowForm(){
		
		itemDetilModel = new HargaAlternatifItemModel();
		itemDetilView = new HargaAlternatifItemView(itemDetilModel);
		itemDetilPresenter = new HargaAlternatifItemPresenter(itemDetilModel, itemDetilView);
	...
	public HargaAlternatifHelper getHelper() {
		return helper;
	}
	...
	public HargaAlternatifItemModel getItemDetilModel() {
		return itemDetilModel;
	}

	public HargaAlternatifItemView getItemDetilView() {
		return itemDetilView;
	}

	public HargaAlternatifItemPresenter getItemDetilPresenter() {
	...
	public void setHelper(HargaAlternatifHelper helper) {
		this.helper = helper;
	}
	...
	public void setItemDetilModel(HargaAlternatifItemModel itemDetilModel) {
		this.itemDetilModel = itemDetilModel;
	}

	public void setItemDetilView(HargaAlternatifItemView itemDetilView) {
		this.itemDetilView = itemDetilView;
	}

	public void setItemDetilPresenter(
			HargaAlternatifItemPresenter itemDetilPresenter) {
