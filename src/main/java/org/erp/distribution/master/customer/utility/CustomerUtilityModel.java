...
public class CustomerUtilityModel extends CustomComponent{
	//1. DAO SERVICE
...
//	protected MenuAccessTemp menuAccessTemp;
	...
	private BeanItemContainer<FCustomergroup> beanItemContainerCustomergroup = 
...
//		setTransaksiHelper((((DashboardUI) getUI().getCurrent()).getTransaksiHelper()));
	...
	public void reload(){
		...
		beanItemContainerCustomergroup.addAll(fCustomergroupJpaService.findAll());
	...
	public BeanItemContainer<FCustomergroup> getBeanItemContainerCustomergroup() {
	...
	public void setBeanItemContainerCustomergroup(
			BeanItemContainer<FCustomergroup> beanItemContainerCustomergroup) {
