...
public class CustomerChannelView extends CustomComponent{
	...
	private TextField fieldId = new TextField("ID CHANNEL");
	private ComboBox comboGrup = new ComboBox("P.");
	private TextField fieldDescription= new TextField("CHANNEL CUSTOMER");
	...
	private TextField fieldSearchById = new TextField("ID CHANNEL");
	private TextField fieldSearchByDesc = new TextField("CHANNEL CUSTOMER");
	...
	public CustomerChannelView(CustomerChannelModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		//set header
		table.setColumnHeader("id", "ID CHANNEL");
		table.setColumnHeader("description", "CHANNEL");
