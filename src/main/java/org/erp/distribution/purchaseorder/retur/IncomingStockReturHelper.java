...
public class IncomingStockReturHelper {
	
	private IncomingStockReturModel model;
	private IncomingStockReturView view;
	
	public IncomingStockReturHelper(IncomingStockReturModel model, IncomingStockReturView view){
		this.model = model;
		this.view = view;
	}
