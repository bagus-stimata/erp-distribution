...
import org.erp.distribution.purchaseorder.retur.windowitem.IncomingStockReturItemModel;
import org.erp.distribution.purchaseorder.retur.windowitem.IncomingStockReturItemPresenter;
import org.erp.distribution.purchaseorder.retur.windowitem.IncomingStockReturItemView;
...
public class IncomingStockReturView extends CustomComponent{
	private IncomingStockReturModel model;

	IncomingStockReturHelper helper;
	...
	//LIST
	private TextField fieldSearch1 = new TextField("NO. DOK RETUR");
	...
	//DETIL
	private TextField fieldNopo = new TextField("NO. DOK RETUR");
	...
	public IncomingStockReturView(IncomingStockReturModel model){
		this.model = model;
		helper = new IncomingStockReturHelper(model, this);
...
//		tableList.setColumnAlignment("invoiceno", Align.RIGHT);
		...
		//set header
		tableList.setColumnHeader("nopo", "NO. DOK RETUR");
...
//			tableDetil.setColumnCollapsed("subtotalafterdiscafterppn", true);
	...
	private IncomingStockReturItemModel itemDetilModel;
	private IncomingStockReturItemView itemDetilView;
	private IncomingStockReturItemPresenter itemDetilPresenter;
	private Window windowForm = new Window();
	
	public void showWindowForm(){
		
		itemDetilModel = new IncomingStockReturItemModel();
		itemDetilView = new IncomingStockReturItemView(itemDetilModel);
		itemDetilPresenter = new IncomingStockReturItemPresenter(itemDetilModel, itemDetilView);
	...
	public IncomingStockReturModel getModel() {
		return model;
	}

	public IncomingStockReturHelper getHelper() {
		return helper;
	}
	...
	public IncomingStockReturItemModel getItemDetilModel() {
		return itemDetilModel;
	}

	public IncomingStockReturItemView getItemDetilView() {
		return itemDetilView;
	}

	public IncomingStockReturItemPresenter getItemDetilPresenter() {
	...
	public void setModel(IncomingStockReturModel model) {
		this.model = model;
	}

	public void setHelper(IncomingStockReturHelper helper) {
		this.helper = helper;
	}
	...
	public void setItemDetilModel(IncomingStockReturItemModel itemDetilModel) {
		this.itemDetilModel = itemDetilModel;
	}

	public void setItemDetilView(IncomingStockReturItemView itemDetilView) {
		this.itemDetilView = itemDetilView;
	}

	public void setItemDetilPresenter(
			IncomingStockReturItemPresenter itemDetilPresenter) {
