...
public class IncomingStockItemView extends CustomComponent {
	...
	public IncomingStockItemView(IncomingStockItemModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(fieldNomorUrut);
		...
		layoutTop.addComponent(panelFieldPpriceafterppn);
...
//		layoutTop.setComponentAlignment(btnClose, Alignment.BOTTOM_CENTER);
	...
	public void setParamterSystemRole(){
		if (model.getSysvarHelper().isEntryItemPembelianHargaSelelahPPN()==true){
			fieldPprice.setVisible(false);
			panelFieldPprice.setVisible(false);
			fieldPpriceafterppn.setVisible(true);			
			panelFieldPpriceafterppn.setVisible(true);
		}else {
			fieldPprice.setVisible(true);
			panelFieldPprice.setVisible(true);
			fieldPpriceafterppn.setVisible(false);			
			panelFieldPpriceafterppn.setVisible(false);
		}
		
		if (model.getSysvarHelper().isLockHJualFJual()==true){
			fieldPprice.setReadOnly(true);
			fieldPpriceafterppn.setReadOnly(true);
		}else {
			fieldPprice.setReadOnly(false);
			fieldPpriceafterppn.setReadOnly(false);
	...
	public void setModel(IncomingStockItemModel model) {
		this.model = model;
	}
