...
public class LapIncomingStockView extends CustomComponent{
	...
	public LapIncomingStockView(LapIncomingStockModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(comboGroup1);
	...
	public LapIncomingStockModel getModel() {
		return model;
	}
	...
	public void setModel(LapIncomingStockModel model) {
		this.model = model;
	}
