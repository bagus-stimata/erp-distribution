package org.erp.distribution.purchaseorder.incomingstock.lapincomingstock;
...
public class LapIncomingStockPresenter implements ClickListener{
	private LapIncomingStockModel model;
	private LapIncomingStockView view;

	public LapIncomingStockPresenter(LapIncomingStockModel model, LapIncomingStockView view){
		this.model = model;
		this.view = view;
		initListener();
	}
	...
	public void preview(){
		...
		showPreview("/erp/distribution/reports/purchase/incomingstock/lapincomingpervendorperbarang1.jasper", "incomingpervendorperbarang1");
