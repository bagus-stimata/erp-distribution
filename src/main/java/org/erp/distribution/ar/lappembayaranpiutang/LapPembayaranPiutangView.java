...
public class LapPembayaranPiutangView extends CustomComponent{
	...
	public LapPembayaranPiutangView(LapPembayaranPiutangModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		comboGroup1.setContainerDataSource(model.getBeanItemContainerWarehouse());
	...
	public LapPembayaranPiutangModel getModel() {
		return model;
	}
	...
	public void setModel(LapPembayaranPiutangModel model) {
		this.model = model;
	}
