...
public class LapPiutangCustomerSalesmanAreaView extends CustomComponent {
	...
	public LapPiutangCustomerSalesmanAreaView(LapPiutangCustomerSalesmanAreaModel model){
		this.model = model;		
...
//			btnCancelForm.addStyleName("small");
	...
	public LapPiutangCustomerSalesmanAreaModel getModel() {
		return model;
	}
	...
	public void setModel(LapPiutangCustomerSalesmanAreaModel model) {
		this.model = model;
	}
