...
public class LapPiutangSalesmanAreaView extends CustomComponent {
	
	private LapPiutangSalesmanAreaModel model;
	...
	public LapPiutangSalesmanAreaView(LapPiutangSalesmanAreaModel model){
		this.model = model;		
...
//		table = new Table("Table:", model.getTableJpaContainer());		
		...
		btnPrint = new Button("Print Piutang");
...
//			btnCancelForm.addStyleName("small");
	...
	public LapPiutangSalesmanAreaModel getModel() {
		return model;
	}
	...
	public void setModel(LapPiutangSalesmanAreaModel model) {
		this.model = model;
	}
