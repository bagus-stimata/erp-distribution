...
public class LapSaldoPiutangPerCustomerPresenter implements ClickListener{
	private LapSaldoPiutangPerCustomerModel model;
	private LapSaldoPiutangPerCustomerView view;

	public LapSaldoPiutangPerCustomerPresenter(LapSaldoPiutangPerCustomerModel model, LapSaldoPiutangPerCustomerView view){
		this.model = model;
		this.view = view;
		initListener();
	}
	...
	public void preview(){
		...
		showPreview("/erp/distribution/reports/arpayment/saldopiutang/saldopiutang.jasper", "saldo_stok");
