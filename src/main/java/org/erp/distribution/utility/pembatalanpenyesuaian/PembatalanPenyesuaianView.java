...
public class PembatalanPenyesuaianView extends CustomComponent{
	...
	private DateField dateField1From = new DateField("TANGGAL STOK OPNAME/PENYESUAIAN/ADJUST");
	private DateField dateField1To = new DateField("S.D");
	
	private Button btnProcess = new Button("Proses Pembatalan");
	...
	public PembatalanPenyesuaianView(PembatalanPenyesuaianModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(comboGroup2);
	...
	public PembatalanPenyesuaianModel getModel() {
		return model;
	}
	...
	public void setModel(PembatalanPenyesuaianModel model) {
		this.model = model;
	}
