...
public class ExportImportSipTigaDaraView extends CustomComponent{
	private ExportImportSipTigaDaraModel model;

	private VerticalLayout content = new VerticalLayout();
	private ComboBox comboGroup1= new ComboBox("SALESMAN");
	private ComboBox comboGroup2= new ComboBox("GUDANG");

	private DateField dateField1From = new DateField("TANGGAL TRANSAKSI/TANGGAL STOCK");
	private DateField dateField1To = new DateField("S.D");
	
	
	private Button btnImport = new Button("Import Penjualan");
	private Button btnExport = new Button("Export database.xml");
	...
	public ExportImportSipTigaDaraView(ExportImportSipTigaDaraModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		layoutTop.addComponent(dateField1To);
		...
		layoutBottom.addComponent(btnExport);
		layoutBottom.addComponent(btnImport);
	...
	public void setDisplay(){
		comboGroup1.setContainerDataSource(model.getBeanItemContainerSalesman());
		...
		comboGroup2.setContainerDataSource(model.getBeanItemContainerWarehouse());
	...
	public ExportImportSipTigaDaraModel getModel() {
		return model;
	}
	...
	public void setModel(ExportImportSipTigaDaraModel model) {
		this.model = model;
	}
